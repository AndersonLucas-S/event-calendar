        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <dl class="row">
                        <dt class="col-sm-3" style="display: none;">ID do evento</dt>
                        ...
                        <dd class="col-sm-9" id="observation"></dd>
                    </dl>
                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#editButton').click(function () {
                var eventId = $('#id').text(); 
                window.location.href = 'editar_evento.php?id=' + eventId;
            });

            $('#deleteButton').click(function () {
                var eventId = $('#id').text(); 
                window.location.href = 'excluir_evento.php?id=' + eventId;
